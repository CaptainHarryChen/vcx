...
namespace VCX::Labs::Rendering {
    ...
    static glm::vec3 DirectLight(const RayIntersector & intersector, const Ray & ray, const RayHit &rayHit, bool enableShadow) {
    ...
    CaseCaustic::CaseCaustic(const std::initializer_list<Assets::ExampleScene> & scenes):
        CaseSimple(scenes),
        _causticPointItem(Engine::GL::VertexLayout().Add<glm::vec3>("position", Engine::GL::DrawFrequency::Stream, 0), Engine::GL::PrimitiveType::Points) {
    }
